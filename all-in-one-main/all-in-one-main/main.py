    ...
    def main():
        ...
        for privatekey in KEYS_LIST:
            ...
            def swap_1inch():
                ...
                CHAIN = 'MATIC' 
                FROM_TOKEN_ADDRESS = '0x0000000000000000000000000000000000001010' # пусто, если eth
                TO_TOKEN_ADDRESS = '0x2f6f07cdcf3588944bf4c42ac74ff24bf56e7590' # пусто, если eth
                AMOUNT_TO_SWAP = 1
                ...
                MIN_BALANCE = 0.2 # останется FROM_TOKEN на балансе после свапа
